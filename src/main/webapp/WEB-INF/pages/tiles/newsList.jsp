...
<fmt:message bundle="${loc}" key="newsList.newsLink" var="newsList_newsLink" />
<fmt:message bundle="${loc}" key="newsList.editLink" var="newsList_editLink" />
<fmt:message bundle="${loc}" key="newsList.viewLink" var="newsList_viewLink" />
<fmt:message bundle="${loc}" key="newsList.deleteButton" var="newsList_deleteButton" />
				...
				<div class="news-link-to-wrapper">
					<div class="link-position">
						<c:if test="${sessionScope.role eq 'admin'}">
						      <a href="controller?command=go_to_edit_news_page&id=${news.idNews}">${newsList_editLink} </a> 
						</c:if>
