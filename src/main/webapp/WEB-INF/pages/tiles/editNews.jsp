...
<fmt:message bundle="${loc}" key="editNews.content" var="editNews_content" /> 
<fmt:message bundle="${loc}" key="editNews.saveButton" var="editNews_saveButton" /> 
<fmt:message bundle="${loc}" key="editNews.cancelButton" var="editNews_cancelButton" />     
...
<div class="add-table-margin">
	<table class="news_text_format">
		...
		<tr>
			...
			<td class="space_around_view_text"><div class="word-breaker">
					<input type="text" name="brief" value="${requestScope.news.briefNews }" />
				</div></td>
		</tr>
		<tr>
...
<div class="second-view-button">
	<form action="controller" method="post">
		...
		<input type="submit" value="${editNews_cancelButton}" />
	</form>
</div>
</c:if>