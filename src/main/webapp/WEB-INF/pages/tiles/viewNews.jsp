...
<fmt:message bundle="${loc}" key="viewNews.newsLink" var="viewNews_newsLink" />
...
<fmt:message bundle="${loc}" key="viewNews.content" var="viewNews_content" />
<fmt:message bundle="${loc}" key="viewNews.editButton" var="viewNews_editButton" />
<fmt:message bundle="${loc}" key="viewNews.deleteButton" var="viewNews_deleteButton" />
...
<div class="first-view-button">
	<form action="controller" method="post">
		...
		<input type="submit" value="${viewNews_editButton}" />
	</form>
</div>
