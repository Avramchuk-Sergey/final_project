...
<fmt:message bundle="${loc}" key="addNews.newsListLink" var="addNews_newsListLink" />
...
<fmt:message bundle="${loc}" key="addNews.addNewsButton" var="addNews_addNewsButton" />
<fmt:message bundle="${loc}" key="addNews.cancelButton" var="addNews_cancelButton" />

<div class="body-title">
	<a href="controller?command=go_to_news_list">${addNews_newsListLink } </a> 
</div>
